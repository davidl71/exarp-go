...
4. **llamacpp backend** — Direct GGUF inference via go-llama.cpp. No HTTP server required. Supports Metal (macOS) and CUDA (Linux). See `docs/LLAMACPP_BUILD_REQUIREMENTS.md`.
