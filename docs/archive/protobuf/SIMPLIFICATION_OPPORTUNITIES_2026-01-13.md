# Protobuf simplification opportunities (archived 2026-03-30)

> **Historical.** Most recommendations here are implemented. Current map: [PROTOBUF_IMPLEMENTATION_STATUS.md](../../PROTOBUF_IMPLEMENTATION_STATUS.md).
