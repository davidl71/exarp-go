...
// Resources = 39 (28 RegisterResource + 11 RegisterResourceTemplate calls):
// config(2) + scorecard + memories(6) + prompts(4) + session(2) + server + models + cursor/skills + tools(2) + tasks(7) + agent/card + prime/context = 28 resources
