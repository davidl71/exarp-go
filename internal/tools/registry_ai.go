		...
		framework.ToolSchema{
			...
			Properties: map[string]interface{}{
				"provider": map[string]interface{}{
					...
					"default":     "fm",
					"description": "Backend: fm (Apple/chain), ollama (native Ollama), insight (report), mlx (Apple Silicon), localai (OpenAI-compatible), gateway (OpenAI-compatible router), llamacpp (local GGUF via llama.cpp), or auto (model selection from task_type/task_description)",
				},
				"prompt": map[string]interface{}{
					"type":        "string",
