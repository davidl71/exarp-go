...
func (m model) viewHelp() string {
	...
	b.WriteString(helpStyle.Render(bindingList(m.bindingsFor(KeyActionToggleAutoRefresh))))
	...
	b.WriteString("  Quit\n  ")
	b.WriteString(helpStyle.Render(bindingList(m.bindingsFor(KeyActionHelp))))
	b.WriteString("  This help\n\n")
	b.WriteString(borderStyle.Render(strings.Repeat("─", availableWidth)))
	b.WriteString("\n")
	b.WriteString(statusBarStyle.Render("Press " + bindingList(m.bindingsFor(KeyActionHelp)) + " or Esc to close help"))
