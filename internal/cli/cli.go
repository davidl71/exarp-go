...
func showUsage() {
	...
	_, _ = fmt.Println("  task update <task-id> [--new-status <status>] [--new-priority <priority>] [--dependencies <ids>] [--parent-id <task-id>]")
	_, _ = fmt.Println("  task create <name> [--description <text>] [--priority <priority>] [--dependencies <ids>] [--parent-id <task-id>]")
