...
// OutputFormat is a shared output formatting selector used across tools.
// Keep string fields for compatibility; internal code should prefer output_format_enum.
...
func (OutputFormat) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[0].Descriptor()
}

func (OutputFormat) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[0]
}
...
// ReportAction selects the report action.
...
func (ReportAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[1].Descriptor()
}

func (ReportAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[1]
}
...
// TaskWorkflowAction selects the task_workflow action.
...
const (
	...
	TaskWorkflowAction_TASK_WORKFLOW_ACTION_IMPORT_SQLITE          TaskWorkflowAction = 37
)

// Enum value maps for TaskWorkflowAction.
var (
	TaskWorkflowAction_name = map[int32]string{
		0:  "TASK_WORKFLOW_ACTION_UNSPECIFIED",
		1:  "TASK_WORKFLOW_ACTION_SYNC",
		2:  "TASK_WORKFLOW_ACTION_APPROVE",
		3:  "TASK_WORKFLOW_ACTION_CLARIFY",
		4:  "TASK_WORKFLOW_ACTION_CLARITY",
		5:  "TASK_WORKFLOW_ACTION_CLEANUP",
		6:  "TASK_WORKFLOW_ACTION_CREATE",
		7:  "TASK_WORKFLOW_ACTION_UPDATE",
		...
		37: "TASK_WORKFLOW_ACTION_IMPORT_SQLITE",
	}
	TaskWorkflowAction_value = map[string]int32{
		...
		"TASK_WORKFLOW_ACTION_IMPORT_SQLITE":          37,
	}
)

func (x TaskWorkflowAction) Enum() *TaskWorkflowAction {
	p := new(TaskWorkflowAction)
	*p = x
	return p
}

func (x TaskWorkflowAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TaskWorkflowAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[2].Descriptor()
}

func (TaskWorkflowAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[2]
}

func (x TaskWorkflowAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TaskWorkflowAction.Descriptor instead.
func (TaskWorkflowAction) EnumDescriptor() ([]byte, []int) {
	return file_proto_tools_proto_rawDescGZIP(), []int{2}
}

// TaskAnalysisAction selects the task_analysis action.
...
var (
	TaskAnalysisAction_name = map[int32]string{
		0:  "TASK_ANALYSIS_ACTION_UNSPECIFIED",
		1:  "TASK_ANALYSIS_ACTION_DUPLICATES",
		2:  "TASK_ANALYSIS_ACTION_TAGS",
		3:  "TASK_ANALYSIS_ACTION_DISCOVER_TAGS",
		4:  "TASK_ANALYSIS_ACTION_HIERARCHY",
		5:  "TASK_ANALYSIS_ACTION_DEPENDENCIES",
		6:  "TASK_ANALYSIS_ACTION_PARALLELIZATION",
		7:  "TASK_ANALYSIS_ACTION_CONFLICTS",
...
func (x TaskAnalysisAction) Enum() *TaskAnalysisAction {
	p := new(TaskAnalysisAction)
	*p = x
	return p
}

func (x TaskAnalysisAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TaskAnalysisAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[3].Descriptor()
}

func (TaskAnalysisAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[3]
}

func (x TaskAnalysisAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TaskAnalysisAction.Descriptor instead.
func (TaskAnalysisAction) EnumDescriptor() ([]byte, []int) {
	return file_proto_tools_proto_rawDescGZIP(), []int{3}
}

// SessionAction selects the session tool action.
type SessionAction int32

const (
	SessionAction_SESSION_ACTION_UNSPECIFIED SessionAction = 0
	SessionAction_SESSION_ACTION_PRIME       SessionAction = 1
	SessionAction_SESSION_ACTION_HANDOFF     SessionAction = 2
	SessionAction_SESSION_ACTION_PROMPTS     SessionAction = 3
	SessionAction_SESSION_ACTION_ASSIGNEE    SessionAction = 4
)
...
var (
	SessionAction_name = map[int32]string{
		...
		1: "SESSION_ACTION_PRIME",
		2: "SESSION_ACTION_HANDOFF",
		3: "SESSION_ACTION_PROMPTS",
		4: "SESSION_ACTION_ASSIGNEE",
	}
	SessionAction_value = map[string]int32{
		"SESSION_ACTION_UNSPECIFIED": 0,
		"SESSION_ACTION_PRIME":       1,
		"SESSION_ACTION_HANDOFF":     2,
		"SESSION_ACTION_PROMPTS":     3,
		"SESSION_ACTION_ASSIGNEE":    4,
	}
)
...
func (SessionAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[4].Descriptor()
}

func (SessionAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[4]
}
...
// HealthAction selects the health tool action.
type HealthAction int32

const (
	HealthAction_HEALTH_ACTION_UNSPECIFIED HealthAction = 0
	HealthAction_HEALTH_ACTION_SERVER      HealthAction = 1
	HealthAction_HEALTH_ACTION_GIT         HealthAction = 2
	HealthAction_HEALTH_ACTION_DOCS        HealthAction = 3
	HealthAction_HEALTH_ACTION_DOD         HealthAction = 4
	HealthAction_HEALTH_ACTION_CICD        HealthAction = 5
	HealthAction_HEALTH_ACTION_TOOLS       HealthAction = 6
	HealthAction_HEALTH_ACTION_CTAGS       HealthAction = 7
)

// Enum value maps for HealthAction.
var (
	HealthAction_name = map[int32]string{
		0: "HEALTH_ACTION_UNSPECIFIED",
		1: "HEALTH_ACTION_SERVER",
		2: "HEALTH_ACTION_GIT",
		3: "HEALTH_ACTION_DOCS",
		4: "HEALTH_ACTION_DOD",
		5: "HEALTH_ACTION_CICD",
		6: "HEALTH_ACTION_TOOLS",
		7: "HEALTH_ACTION_CTAGS",
	}
	HealthAction_value = map[string]int32{
		"HEALTH_ACTION_UNSPECIFIED": 0,
		"HEALTH_ACTION_SERVER":      1,
		"HEALTH_ACTION_GIT":         2,
		"HEALTH_ACTION_DOCS":        3,
		"HEALTH_ACTION_DOD":         4,
		"HEALTH_ACTION_CICD":        5,
		"HEALTH_ACTION_TOOLS":       6,
		"HEALTH_ACTION_CTAGS":       7,
	}
)

func (x HealthAction) Enum() *HealthAction {
	p := new(HealthAction)
	*p = x
	return p
}

func (x HealthAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HealthAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[5].Descriptor()
}

func (HealthAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[5]
}

func (x HealthAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HealthAction.Descriptor instead.
func (HealthAction) EnumDescriptor() ([]byte, []int) {
	return file_proto_tools_proto_rawDescGZIP(), []int{5}
}

// SecurityAction selects the security tool action.
type SecurityAction int32

const (
	SecurityAction_SECURITY_ACTION_UNSPECIFIED SecurityAction = 0
	SecurityAction_SECURITY_ACTION_SCAN        SecurityAction = 1
	SecurityAction_SECURITY_ACTION_ALERTS      SecurityAction = 2
	SecurityAction_SECURITY_ACTION_REPORT      SecurityAction = 3
)
...
var (
	SecurityAction_name = map[int32]string{
		...
		1: "SECURITY_ACTION_SCAN",
		2: "SECURITY_ACTION_ALERTS",
		3: "SECURITY_ACTION_REPORT",
	}
	SecurityAction_value = map[string]int32{
		"SECURITY_ACTION_UNSPECIFIED": 0,
		"SECURITY_ACTION_SCAN":        1,
		"SECURITY_ACTION_ALERTS":      2,
		"SECURITY_ACTION_REPORT":      3,
	}
)
...
func (SecurityAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[6].Descriptor()
}

func (SecurityAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[6]
}
...
// LintAction selects the lint tool action.
type LintAction int32

const (
	LintAction_LINT_ACTION_UNSPECIFIED LintAction = 0
	LintAction_LINT_ACTION_RUN         LintAction = 1
	LintAction_LINT_ACTION_ANALYZE     LintAction = 2
)

// Enum value maps for LintAction.
var (
	LintAction_name = map[int32]string{
		0: "LINT_ACTION_UNSPECIFIED",
		1: "LINT_ACTION_RUN",
		2: "LINT_ACTION_ANALYZE",
	}
	LintAction_value = map[string]int32{
		"LINT_ACTION_UNSPECIFIED": 0,
		"LINT_ACTION_RUN":         1,
		"LINT_ACTION_ANALYZE":     2,
	}
)

func (x LintAction) Enum() *LintAction {
	p := new(LintAction)
	*p = x
	return p
}

func (x LintAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (LintAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[7].Descriptor()
}

func (LintAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[7]
}

func (x LintAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use LintAction.Descriptor instead.
func (LintAction) EnumDescriptor() ([]byte, []int) {
	return file_proto_tools_proto_rawDescGZIP(), []int{7}
}

// TestingAction selects the testing tool action.
type TestingAction int32

const (
	TestingAction_TESTING_ACTION_UNSPECIFIED TestingAction = 0
	TestingAction_TESTING_ACTION_RUN         TestingAction = 1
	TestingAction_TESTING_ACTION_COVERAGE    TestingAction = 2
	TestingAction_TESTING_ACTION_SUGGEST     TestingAction = 3
	TestingAction_TESTING_ACTION_VALIDATE    TestingAction = 4
)

// Enum value maps for TestingAction.
var (
	TestingAction_name = map[int32]string{
		0: "TESTING_ACTION_UNSPECIFIED",
		1: "TESTING_ACTION_RUN",
		2: "TESTING_ACTION_COVERAGE",
		3: "TESTING_ACTION_SUGGEST",
		4: "TESTING_ACTION_VALIDATE",
	}
	TestingAction_value = map[string]int32{
		"TESTING_ACTION_UNSPECIFIED": 0,
		"TESTING_ACTION_RUN":         1,
		"TESTING_ACTION_COVERAGE":    2,
		"TESTING_ACTION_SUGGEST":     3,
		"TESTING_ACTION_VALIDATE":    4,
	}
)

func (x TestingAction) Enum() *TestingAction {
	p := new(TestingAction)
	*p = x
	return p
}

func (x TestingAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TestingAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[8].Descriptor()
}

func (TestingAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[8]
}

func (x TestingAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use TestingAction.Descriptor instead.
func (TestingAction) EnumDescriptor() ([]byte, []int) {
	return file_proto_tools_proto_rawDescGZIP(), []int{8}
}

// AutomationAction selects the automation tool action.
type AutomationAction int32

const (
	AutomationAction_AUTOMATION_ACTION_UNSPECIFIED AutomationAction = 0
	AutomationAction_AUTOMATION_ACTION_DAILY       AutomationAction = 1
	AutomationAction_AUTOMATION_ACTION_NIGHTLY     AutomationAction = 2
	AutomationAction_AUTOMATION_ACTION_SPRINT      AutomationAction = 3
	AutomationAction_AUTOMATION_ACTION_DISCOVER    AutomationAction = 4
)
...
var (
	AutomationAction_name = map[int32]string{
		...
		1: "AUTOMATION_ACTION_DAILY",
		2: "AUTOMATION_ACTION_NIGHTLY",
		3: "AUTOMATION_ACTION_SPRINT",
		4: "AUTOMATION_ACTION_DISCOVER",
	}
	AutomationAction_value = map[string]int32{
		"AUTOMATION_ACTION_UNSPECIFIED": 0,
		"AUTOMATION_ACTION_DAILY":       1,
		"AUTOMATION_ACTION_NIGHTLY":     2,
		"AUTOMATION_ACTION_SPRINT":      3,
		"AUTOMATION_ACTION_DISCOVER":    4,
	}
)
...
func (AutomationAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[9].Descriptor()
}

func (AutomationAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[9]
}
...
// GitToolsAction selects the git_tools tool action.
type GitToolsAction int32

const (
	GitToolsAction_GIT_TOOLS_ACTION_UNSPECIFIED   GitToolsAction = 0
	GitToolsAction_GIT_TOOLS_ACTION_COMMITS       GitToolsAction = 1
	GitToolsAction_GIT_TOOLS_ACTION_BRANCHES      GitToolsAction = 2
	GitToolsAction_GIT_TOOLS_ACTION_TASKS         GitToolsAction = 3
	GitToolsAction_GIT_TOOLS_ACTION_DIFF          GitToolsAction = 4
	GitToolsAction_GIT_TOOLS_ACTION_GRAPH         GitToolsAction = 5
	GitToolsAction_GIT_TOOLS_ACTION_MERGE         GitToolsAction = 6
	GitToolsAction_GIT_TOOLS_ACTION_SET_BRANCH    GitToolsAction = 7
	GitToolsAction_GIT_TOOLS_ACTION_LOCAL_COMMITS GitToolsAction = 8
)

// Enum value maps for GitToolsAction.
var (
	GitToolsAction_name = map[int32]string{
		0: "GIT_TOOLS_ACTION_UNSPECIFIED",
		1: "GIT_TOOLS_ACTION_COMMITS",
		2: "GIT_TOOLS_ACTION_BRANCHES",
		3: "GIT_TOOLS_ACTION_TASKS",
		4: "GIT_TOOLS_ACTION_DIFF",
		5: "GIT_TOOLS_ACTION_GRAPH",
		6: "GIT_TOOLS_ACTION_MERGE",
		7: "GIT_TOOLS_ACTION_SET_BRANCH",
		8: "GIT_TOOLS_ACTION_LOCAL_COMMITS",
	}
	GitToolsAction_value = map[string]int32{
		"GIT_TOOLS_ACTION_UNSPECIFIED":   0,
		"GIT_TOOLS_ACTION_COMMITS":       1,
		"GIT_TOOLS_ACTION_BRANCHES":      2,
		"GIT_TOOLS_ACTION_TASKS":         3,
		"GIT_TOOLS_ACTION_DIFF":          4,
		"GIT_TOOLS_ACTION_GRAPH":         5,
		"GIT_TOOLS_ACTION_MERGE":         6,
		"GIT_TOOLS_ACTION_SET_BRANCH":    7,
		"GIT_TOOLS_ACTION_LOCAL_COMMITS": 8,
	}
)

func (x GitToolsAction) Enum() *GitToolsAction {
	p := new(GitToolsAction)
	*p = x
	return p
}

func (x GitToolsAction) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (GitToolsAction) Descriptor() protoreflect.EnumDescriptor {
	return file_proto_tools_proto_enumTypes[10].Descriptor()
}

func (GitToolsAction) Type() protoreflect.EnumType {
	return &file_proto_tools_proto_enumTypes[10]
}

func (x GitToolsAction) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use GitToolsAction.Descriptor instead.
func (GitToolsAction) EnumDescriptor() ([]byte, []int) {
...
type ReportRequest struct {
	...
	// Deprecated: prefer output_format_enum. output_format will be removed after the compatibility window.
	...
	ActionEnum             ReportAction `protobuf:"varint,15,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.ReportAction" json:"action_enum,omitempty"`
	OutputFormatEnum       OutputFormat `protobuf:"varint,16,opt,name=output_format_enum,json=outputFormatEnum,proto3,enum=exarp.tools.OutputFormat" json:"output_format_enum,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *ReportRequest) GetActionEnum() ReportAction {
	if x != nil {
		return x.ActionEnum
	}
...
func (x *ReportRequest) GetOutputFormatEnum() OutputFormat {
	if x != nil {
...
type ReportResponse struct {
	...
	OutputPath    string                 `protobuf:"bytes,3,opt,name=output_path,json=outputPath,proto3" json:"output_path,omitempty"`
	AiInsights    *AIInsights            `protobuf:"bytes,4,opt,name=ai_insights,json=aiInsights,proto3" json:"ai_insights,omitempty"` // LLM-enhanced insights (if available)
...
// ScorecardData represents Go scorecard result for report path (type-safe)
...
type TaskAnalysisRequest struct {
	...
	UseTinyTagModel        bool               `protobuf:"varint,16,opt,name=use_tiny_tag_model,json=useTinyTagModel,proto3" json:"use_tiny_tag_model,omitempty"`      // For action=tags+use_llm_semantic: try Ollama tinyllama for faster inference before larger models.
	ActionEnum             TaskAnalysisAction `protobuf:"varint,17,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.TaskAnalysisAction" json:"action_enum,omitempty"`
	OutputFormatEnum       OutputFormat       `protobuf:"varint,18,opt,name=output_format_enum,json=outputFormatEnum,proto3,enum=exarp.tools.OutputFormat" json:"output_format_enum,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *TaskAnalysisRequest) GetActionEnum() TaskAnalysisAction {
	if x != nil {
		return x.ActionEnum
	}
	return TaskAnalysisAction_TASK_ANALYSIS_ACTION_UNSPECIFIED
}

func (x *TaskAnalysisRequest) GetOutputFormatEnum() OutputFormat {
	if x != nil {
		return x.OutputFormatEnum
	}
	return OutputFormat_OUTPUT_FORMAT_UNSPECIFIED
...
type TaskWorkflowRequest struct {
	...
	// --- Execution / multi-agent (start_run, end_run, list_runs, show_run, verify, add_progress, split, claim) ---
	// These fields are absent from earlier revisions; protojson previously dropped them (unknown fields), breaking MCP/typed clients.
	...
	FilesTouched   []string `protobuf:"bytes,33,rep,name=files_touched,json=filesTouched,proto3" json:"files_touched,omitempty"`
	CommandsRun    []string `protobuf:"bytes,34,rep,name=commands_run,json=commandsRun,proto3" json:"commands_run,omitempty"`
	Kind           string   `protobuf:"bytes,35,opt,name=kind,proto3" json:"kind,omitempty"`
	Command        string   `protobuf:"bytes,36,opt,name=command,proto3" json:"command,omitempty"`
	Details        string   `protobuf:"bytes,37,opt,name=details,proto3" json:"details,omitempty"`
	RemainingWork  string   `protobuf:"bytes,38,opt,name=remaining_work,json=remainingWork,proto3" json:"remaining_work,omitempty"`
	Files          []string `protobuf:"bytes,39,rep,name=files,proto3" json:"files,omitempty"`
	Children       string   `protobuf:"bytes,40,opt,name=children,proto3" json:"children,omitempty"`
	DependencyMode string   `protobuf:"bytes,41,opt,name=dependency_mode,json=dependencyMode,proto3" json:"dependency_mode,omitempty"`
	Limit          int32    `protobuf:"varint,42,opt,name=limit,proto3" json:"limit,omitempty"`
	// end_run status, verify outcome, apply_approval_result (approved/rejected), etc.
	Result       string `protobuf:"bytes,43,opt,name=result,proto3" json:"result,omitempty"`
	AgentId      string `protobuf:"bytes,44,opt,name=agent_id,json=agentId,proto3" json:"agent_id,omitempty"`
	LeaseMinutes int32  `protobuf:"varint,45,opt,name=lease_minutes,json=leaseMinutes,proto3" json:"lease_minutes,omitempty"`
	// import_sqlite: merge external Todo2 SQLite DBs into the current PROJECT_ROOT database.
	// import_sources: JSON array of paths — each may be a path to todo2.db or a project directory (uses .todo2/todo2.db).
	ImportSources string `protobuf:"bytes,46,opt,name=import_sources,json=importSources,proto3" json:"import_sources,omitempty"`
	// import_scan_mode: none | immediate | recursive — when a source path is a directory, discover child project DBs.
	ImportScanMode string `protobuf:"bytes,47,opt,name=import_scan_mode,json=importScanMode,proto3" json:"import_scan_mode,omitempty"`
	// import_on_conflict: fail (default) or skip — when a task id exists in the target with a different content hash.
	ImportOnConflict string `protobuf:"bytes,48,opt,name=import_on_conflict,json=importOnConflict,proto3" json:"import_on_conflict,omitempty"`
	// import_default_project_id: when set, used for tasks with empty project_id instead of the source folder label.
	ImportDefaultProjectId string `protobuf:"bytes,49,opt,name=import_default_project_id,json=importDefaultProjectId,proto3" json:"import_default_project_id,omitempty"`
	// import_sync_json: when true (default), run SQLite↔JSON sync after a successful non-dry import.
	ImportSyncJson bool `protobuf:"varint,50,opt,name=import_sync_json,json=importSyncJson,proto3" json:"import_sync_json,omitempty"`
	// import_max_depth: for import_scan_mode immediate|recursive, max directory depth below each source dir for a project root containing .todo2 (0 = unlimited).
	ImportMaxDepth int32 `protobuf:"varint,51,opt,name=import_max_depth,json=importMaxDepth,proto3" json:"import_max_depth,omitempty"`
	// priority_rank: optional sort key for create/update; lower sorts earlier within the same named priority.
	PriorityRank  int32 `protobuf:"varint,52,opt,name=priority_rank,json=priorityRank,proto3" json:"priority_rank,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TaskWorkflowRequest) GetActionEnum() TaskWorkflowAction {
	if x != nil {
		return x.ActionEnum
	}
	return TaskWorkflowAction_TASK_WORKFLOW_ACTION_UNSPECIFIED
}

func (x *TaskWorkflowRequest) GetOutputFormatEnum() OutputFormat {
	if x != nil {
		return x.OutputFormatEnum
	}
	return OutputFormat_OUTPUT_FORMAT_UNSPECIFIED
...
func (x *TaskWorkflowRequest) GetRunId() string {
	if x != nil {
		return x.RunId
	}
	return ""
...
func (x *TaskWorkflowRequest) GetSummary() string {
	if x != nil {
		return x.Summary
	}
	return ""
...
func (x *TaskWorkflowRequest) GetNotes() string {
	if x != nil {
		return x.Notes
	}
	return ""
...
func (x *TaskWorkflowRequest) GetFilesTouched() []string {
	if x != nil {
...
func (x *TaskWorkflowRequest) GetCommandsRun() []string {
	if x != nil {
...
func (x *TaskWorkflowRequest) GetKind() string {
	if x != nil {
		return x.Kind
	}
	return ""
...
func (x *TaskWorkflowRequest) GetCommand() string {
	if x != nil {
		return x.Command
	}
	return ""
...
func (x *TaskWorkflowRequest) GetDetails() string {
	if x != nil {
		return x.Details
	}
	return ""
...
func (x *TaskWorkflowRequest) GetRemainingWork() string {
	if x != nil {
		return x.RemainingWork
	}
	return ""
}

func (x *TaskWorkflowRequest) GetFiles() []string {
	if x != nil {
		return x.Files
	}
	return nil
...
func (x *TaskWorkflowRequest) GetChildren() string {
	if x != nil {
		return x.Children
	}
	return ""
...
func (x *TaskWorkflowRequest) GetDependencyMode() string {
	if x != nil {
...
func (x *TaskWorkflowRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
func (x *TaskWorkflowRequest) GetResult() string {
	if x != nil {
		return x.Result
	}
	return ""
...
func (x *TaskWorkflowRequest) GetAgentId() string {
	if x != nil {
		return x.AgentId
	}
	return ""
...
func (x *TaskWorkflowRequest) GetLeaseMinutes() int32 {
	if x != nil {
		return x.LeaseMinutes
	}
	return 0
}

func (x *TaskWorkflowRequest) GetImportSources() string {
	if x != nil {
...
func (x *TaskWorkflowRequest) GetImportScanMode() string {
	if x != nil {
		return x.ImportScanMode
	}
	return ""
}

func (x *TaskWorkflowRequest) GetImportOnConflict() string {
	if x != nil {
		return x.ImportOnConflict
	}
	return ""
}

func (x *TaskWorkflowRequest) GetImportDefaultProjectId() string {
	if x != nil {
		return x.ImportDefaultProjectId
	}
	return ""
}

func (x *TaskWorkflowRequest) GetImportSyncJson() bool {
	if x != nil {
		return x.ImportSyncJson
	}
	return false
}

func (x *TaskWorkflowRequest) GetImportMaxDepth() int32 {
	if x != nil {
		return x.ImportMaxDepth
	}
	return 0
}

func (x *TaskWorkflowRequest) GetPriorityRank() int32 {
	if x != nil {
...
func (x *TaskSummary) GetPriorityRank() int32 {
	if x != nil {
		return x.PriorityRank
	}
	return 0
...
type AutomationRequest struct {
	...
	ActionEnum       AutomationAction `protobuf:"varint,16,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.AutomationAction" json:"action_enum,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AutomationRequest) GetActionEnum() AutomationAction {
	if x != nil {
		return x.ActionEnum
	}
...
type TestingRequest struct {
	...
	ActionEnum    TestingAction `protobuf:"varint,13,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.TestingAction" json:"action_enum,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *TestingRequest) GetActionEnum() TestingAction {
	if x != nil {
		return x.ActionEnum
	}
	return TestingAction_TESTING_ACTION_UNSPECIFIED
}
...
type HealthRequest struct {
	...
	ActionEnum    HealthAction `protobuf:"varint,11,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.HealthAction" json:"action_enum,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HealthRequest) GetActionEnum() HealthAction {
	if x != nil {
		return x.ActionEnum
	}
	return HealthAction_HEALTH_ACTION_UNSPECIFIED
}
...
type SecurityRequest struct {
	...
	ActionEnum       SecurityAction `protobuf:"varint,7,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.SecurityAction" json:"action_enum,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *SecurityRequest) GetActionEnum() SecurityAction {
	if x != nil {
		return x.ActionEnum
	}
...
type LintRequest struct {
	...
	ActionEnum    LintAction `protobuf:"varint,11,opt,name=action_enum,json=actionEnum,proto3,enum=exarp.tools.LintAction" json:"action_enum,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *LintRequest) GetActionEnum() LintAction {
	if x != nil {
		return x.ActionEnum
	}
	return LintAction_LINT_ACTION_UNSPECIFIED
}
...
type EstimationRequest struct {
	...
	// Deprecated: Marked as deprecated in proto/tools.proto.
	UseMlx bool `protobuf:"varint,9,opt,name=use_mlx,json=useMlx,proto3" json:"use_mlx,omitempty"` // ignored; reserved for backward compatibility
	// Deprecated: Marked as deprecated in proto/tools.proto.
	MlxWeight          float64              `protobuf:"fixed64,10,opt,name=mlx_weight,json=mlxWeight,proto3" json:"mlx_weight,omitempty"`                // ignored; reserved for backward compatibility
	LocalAiBackend     string               `protobuf:"bytes,11,opt,name=local_ai_backend,json=localAiBackend,proto3" json:"local_ai_backend,omitempty"` // optional: fm|ollama — preferred local LLM for estimate
...
func (x *GitToolsRequest) GetActionEnum() GitToolsAction {
	if x != nil {
		return x.ActionEnum
	}
	return GitToolsAction_GIT_TOOLS_ACTION_UNSPECIFIED
}

func (x *GitToolsRequest) GetFormatEnum() OutputFormat {
	if x != nil {
		return x.FormatEnum
	}
	return OutputFormat_OUTPUT_FORMAT_UNSPECIFIED
...
func (x *SessionRequest) GetActionEnum() SessionAction {
	if x != nil {
		return x.ActionEnum
	}
...
// CachedTaskExecutionPack stores a derived execution-pack resource as JSON bytes,
// wrapped in a protobuf message so the DB cache can store a stable binary payload.
type CachedTaskExecutionPack struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	TaskId        string                 `protobuf:"bytes,1,opt,name=task_id,json=taskId,proto3" json:"task_id,omitempty"`
	TaskVersion   int64                  `protobuf:"varint,2,opt,name=task_version,json=taskVersion,proto3" json:"task_version,omitempty"`
...
func (x *CachedTaskExecutionPack) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CachedTaskExecutionPack) GetTaskVersion() int64 {
	if x != nil {
...
func (x *CachedTaskExecutionPack) GetJsonPayload() []byte {
	if x != nil {
...
func (x *CachedTaskExecutionPack) GetGeneratedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.GeneratedAt
	}
	return nil
...
const file_proto_tools_proto_rawDesc = "" +
	"\n" +
	"\x11proto/tools.proto\x12\vexarp.tools\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc5\x02\n" +
	"\x06Memory\x12\x0e\n" +
	...
	"\x12TokenEstimateEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x01\"\xc5\x05\n" +
	...
	"\rinclude_tasks\x18\x0e \x01(\bR\fincludeTasks\x12:\n" +
	"\vaction_enum\x18\x0f \x01(\x0e2\x19.exarp.tools.ReportActionR\n" +
	"actionEnum\x12G\n" +
	"\x12output_format_enum\x18\x10 \x01(\x0e2\x19.exarp.tools.OutputFormatR\x10outputFormatEnum\"\xb3\x01\n" +
	...
	"\x12use_tiny_tag_model\x18\x10 \x01(\bR\x0fuseTinyTagModel\x12@\n" +
	"\vaction_enum\x18\x11 \x01(\x0e2\x1f.exarp.tools.TaskAnalysisActionR\n" +
	"actionEnum\x12G\n" +
	"\x12output_format_enum\x18\x12 \x01(\x0e2\x19.exarp.tools.OutputFormatR\x10outputFormatEnum\"p\n" +
	...
	"outputPath\x12!\n" +
	"\fcreate_tasks\x18\a \x01(\bR\vcreateTasks\"\xa4\x0e\n" +
	...
	"\fcomment_type\x18\x1d \x01(\tR\vcommentType\x12\x15\n" +
	"\x06run_id\x18\x1e \x01(\tR\x05runId\x12\x18\n" +
	"\asummary\x18\x1f \x01(\tR\asummary\x12\x14\n" +
	"\x05notes\x18  \x01(\tR\x05notes\x12#\n" +
	"\rfiles_touched\x18! \x03(\tR\ffilesTouched\x12!\n" +
	"\fcommands_run\x18\" \x03(\tR\vcommandsRun\x12\x12\n" +
	"\x04kind\x18# \x01(\tR\x04kind\x12\x18\n" +
	"\acommand\x18$ \x01(\tR\acommand\x12\x18\n" +
	"\adetails\x18% \x01(\tR\adetails\x12%\n" +
	"\x0eremaining_work\x18& \x01(\tR\rremainingWork\x12\x14\n" +
	"\x05files\x18' \x03(\tR\x05files\x12\x1a\n" +
	"\bchildren\x18( \x01(\tR\bchildren\x12'\n" +
	"\x0fdependency_mode\x18) \x01(\tR\x0edependencyMode\x12\x14\n" +
	"\x05limit\x18* \x01(\x05R\x05limit\x12\x16\n" +
	"\x06result\x18+ \x01(\tR\x06result\x12\x19\n" +
	"\bagent_id\x18, \x01(\tR\aagentId\x12#\n" +
	"\rlease_minutes\x18- \x01(\x05R\fleaseMinutes\x12%\n" +
	"\x0eimport_sources\x18. \x01(\tR\rimportSources\x12(\n" +
	"\x10import_scan_mode\x18/ \x01(\tR\x0eimportScanMode\x12,\n" +
	"\x12import_on_conflict\x180 \x01(\tR\x10importOnConflict\x129\n" +
	"\x19import_default_project_id\x181 \x01(\tR\x16importDefaultProjectId\x12(\n" +
	"\x10import_sync_json\x182 \x01(\bR\x0eimportSyncJson\x12(\n" +
	"\x10import_max_depth\x183 \x01(\x05R\x0eimportMaxDepth\x12#\n" +
	"\rpriority_rank\x184 \x01(\x05R\fpriorityRank\"\xa0\x02\n" +
	...
	"\x11recommended_tools\x18\b \x03(\tR\x10recommendedTools\x12#\n" +
	"\rpriority_rank\x18\t \x01(\x05R\fpriorityRank\"\x89\x01\n" +
	"\vSyncResults\x12'\n" +
	...
	"\tcancelled\x18\t \x01(\bR\tcancelled\"\xf8\x04\n" +
	...
	"outputPath\x12>\n" +
	"\vaction_enum\x18\x10 \x01(\x0e2\x1d.exarp.tools.AutomationActionR\n" +
	"actionEnum\"\xc6\x03\n" +
	...
	"outputPath\x12;\n" +
	"\vaction_enum\x18\r \x01(\x0e2\x1a.exarp.tools.TestingActionR\n" +
	"actionEnum\"d\n" +
	...
	"\adry_run\x18\t \x01(\bR\x06dryRun\"\x90\x03\n" +
	...
	"\rcheck_runners\x18\n" +
	" \x01(\bR\fcheckRunners\x12:\n" +
	"\vaction_enum\x18\v \x01(\x0e2\x19.exarp.tools.HealthActionR\n" +
	"actionEnum\"\xfd\x01\n" +
	...
	"\x11include_dismissed\x18\x06 \x01(\bR\x10includeDismissed\x12<\n" +
	"\vaction_enum\x18\a \x01(\x0e2\x1b.exarp.tools.SecurityActionR\n" +
	"actionEnum\"\xd2\x02\n" +
	...
	"\bdetailed\x18\b \x01(\bR\bdetailed\x12\x1b\n" +
	"\ause_mlx\x18\t \x01(\bB\x02\x18\x01R\x06useMlx\x12!\n" +
	"\n" +
	"mlx_weight\x18\n" +
	" \x01(\x01B\x02\x18\x01R\tmlxWeight\x12(\n" +
	...
	"\adry_run\x18\x10 \x01(\bR\x06dryRun\x12<\n" +
	...
	"\n" +
	"level_enum\x18\x11 \x01(\x0e2!.exarp.tools.LocalLLMSummaryLevelR\tlevelEnum\"\xc0\x01\n" +
	...
	"\rbudget_tokens\x18\x02 \x01(\x05R\fbudgetTokens\"\xb7\x01\n" +
	"\x17CachedTaskExecutionPack\x12\x17\n" +
	"\atask_id\x18\x01 \x01(\tR\x06taskId\x12!\n" +
	"\ftask_version\x18\x02 \x01(\x03R\vtaskVersion\x12!\n" +
	"\fjson_payload\x18\x03 \x01(\fR\vjsonPayload\x12=\n" +
	"\fgenerated_at\x18\x04 \x01(\v2\x1a.google.protobuf.TimestampR\vgeneratedAt*y\n" +
	...
	"$REPORT_ACTION_UPDATE_WAVES_FROM_PLAN\x10\t*\x9a\v\n" +
	"\x12TaskWorkflowAction\x12$\n" +
	" TASK_WORKFLOW_ACTION_UNSPECIFIED\x10\x00\x12\x1d\n" +
	"\x19TASK_WORKFLOW_ACTION_SYNC\x10\x01\x12 \n" +
	"\x1cTASK_WORKFLOW_ACTION_APPROVE\x10\x02\x12 \n" +
	"\x1cTASK_WORKFLOW_ACTION_CLARIFY\x10\x03\x12 \n" +
	"\x1cTASK_WORKFLOW_ACTION_CLARITY\x10\x04\x12 \n" +
	"\x1cTASK_WORKFLOW_ACTION_CLEANUP\x10\x05\x12\x1f\n" +
	"\x1bTASK_WORKFLOW_ACTION_CREATE\x10\x06\x12\x1f\n" +
	"\x1bTASK_WORKFLOW_ACTION_UPDATE\x10\a\x12\x1f\n" +
	...
	"\x1aTASK_WORKFLOW_ACTION_SPLIT\x10$\x12&\n" +
	"\"TASK_WORKFLOW_ACTION_IMPORT_SQLITE\x10%*\xb8\x06\n" +
	"\x12TaskAnalysisAction\x12$\n" +
	" TASK_ANALYSIS_ACTION_UNSPECIFIED\x10\x00\x12#\n" +
	"\x1fTASK_ANALYSIS_ACTION_DUPLICATES\x10\x01\x12\x1d\n" +
	"\x19TASK_ANALYSIS_ACTION_TAGS\x10\x02\x12&\n" +
	"\"TASK_ANALYSIS_ACTION_DISCOVER_TAGS\x10\x03\x12\"\n" +
	"\x1eTASK_ANALYSIS_ACTION_HIERARCHY\x10\x04\x12%\n" +
	"!TASK_ANALYSIS_ACTION_DEPENDENCIES\x10\x05\x12(\n" +
	"$TASK_ANALYSIS_ACTION_PARALLELIZATION\x10\x06\x12\"\n" +
	"\x1eTASK_ANALYSIS_ACTION_CONFLICTS\x10\a\x12%\n" +
	...
	"\x16SESSION_ACTION_HANDOFF\x10\x02\x12\x1a\n" +
	"\x16SESSION_ACTION_PROMPTS\x10\x03\x12\x1b\n" +
	"\x17SESSION_ACTION_ASSIGNEE\x10\x04*\xd7\x01\n" +
	"\fHealthAction\x12\x1d\n" +
	"\x19HEALTH_ACTION_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14HEALTH_ACTION_SERVER\x10\x01\x12\x15\n" +
	"\x11HEALTH_ACTION_GIT\x10\x02\x12\x16\n" +
	"\x12HEALTH_ACTION_DOCS\x10\x03\x12\x15\n" +
	"\x11HEALTH_ACTION_DOD\x10\x04\x12\x16\n" +
	"\x12HEALTH_ACTION_CICD\x10\x05\x12\x17\n" +
	"\x13HEALTH_ACTION_TOOLS\x10\x06\x12\x17\n" +
	"\x13HEALTH_ACTION_CTAGS\x10\a*\x83\x01\n" +
	"\x0eSecurityAction\x12\x1f\n" +
	"\x1bSECURITY_ACTION_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14SECURITY_ACTION_SCAN\x10\x01\x12\x1a\n" +
	"\x16SECURITY_ACTION_ALERTS\x10\x02\x12\x1a\n" +
	"\x16SECURITY_ACTION_REPORT\x10\x03*W\n" +
	"\n" +
	"LintAction\x12\x1b\n" +
	"\x17LINT_ACTION_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fLINT_ACTION_RUN\x10\x01\x12\x17\n" +
	"\x13LINT_ACTION_ANALYZE\x10\x02*\x9d\x01\n" +
	"\rTestingAction\x12\x1e\n" +
	"\x1aTESTING_ACTION_UNSPECIFIED\x10\x00\x12\x16\n" +
	"\x12TESTING_ACTION_RUN\x10\x01\x12\x1b\n" +
	"\x17TESTING_ACTION_COVERAGE\x10\x02\x12\x1a\n" +
	"\x16TESTING_ACTION_SUGGEST\x10\x03\x12\x1b\n" +
	"\x17TESTING_ACTION_VALIDATE\x10\x04*\xaf\x01\n" +
	"\x10AutomationAction\x12!\n" +
	"\x1dAUTOMATION_ACTION_UNSPECIFIED\x10\x00\x12\x1b\n" +
	"\x17AUTOMATION_ACTION_DAILY\x10\x01\x12\x1d\n" +
	"\x19AUTOMATION_ACTION_NIGHTLY\x10\x02\x12\x1c\n" +
	"\x18AUTOMATION_ACTION_SPRINT\x10\x03\x12\x1e\n" +
	"\x1aAUTOMATION_ACTION_DISCOVER\x10\x04*\xa3\x02\n" +
	"\x0eGitToolsAction\x12 \n" +
	"\x1cGIT_TOOLS_ACTION_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18GIT_TOOLS_ACTION_COMMITS\x10\x01\x12\x1d\n" +
	"\x19GIT_TOOLS_ACTION_BRANCHES\x10\x02\x12\x1a\n" +
	"\x16GIT_TOOLS_ACTION_TASKS\x10\x03\x12\x19\n" +
	...
	"\x1bGIT_TOOLS_ACTION_SET_BRANCH\x10\a\x12\"\n" +
	"\x1eGIT_TOOLS_ACTION_LOCAL_COMMITS\x10\b*\xbe\x01\n" +
	...
	" LOCAL_LLM_DOCSTRING_STYLE_SPHINX\x10\x03*\x8e\x01\n" +
	"\x0fLocalLLMBackend\x12!\n" +
	"\x1dLOCAL_LLM_BACKEND_UNSPECIFIED\x10\x00\x12\x18\n" +
	"\x14LOCAL_LLM_BACKEND_FM\x10\x01\x12\x1c\n" +
	"\x18LOCAL_LLM_BACKEND_OLLAMA\x10\x03\x12\x1a\n" +
	"\x16LOCAL_LLM_BACKEND_AUTO\x10\x04\"\x04\b\x02\x10\x02B$Z\"github.com/davidl71/exarp-go/protob\x06proto3"
...
var file_proto_tools_proto_goTypes = []any{
	...
	(TaskWorkflowAction)(0),             // 2: exarp.tools.TaskWorkflowAction
	(TaskAnalysisAction)(0),             // 3: exarp.tools.TaskAnalysisAction
	(SessionAction)(0),                  // 4: exarp.tools.SessionAction
	(HealthAction)(0),                   // 5: exarp.tools.HealthAction
	(SecurityAction)(0),                 // 6: exarp.tools.SecurityAction
	(LintAction)(0),                     // 7: exarp.tools.LintAction
	...
	(*PromptTrackingRequest)(nil),       // 84: exarp.tools.PromptTrackingRequest
	(*RecommendRequest)(nil),            // 85: exarp.tools.RecommendRequest
	(*InferSessionModeRequest)(nil),     // 86: exarp.tools.InferSessionModeRequest
	(*ContextBudgetRequest)(nil),        // 87: exarp.tools.ContextBudgetRequest
	(*CachedTaskExecutionPack)(nil),     // 88: exarp.tools.CachedTaskExecutionPack
	nil,                                 // 89: exarp.tools.Memory.MetadataEntry
	nil,                                 // 90: exarp.tools.MemoryResponse.CategoriesEntry
	nil,                                 // 91: exarp.tools.ContextResponse.TokenEstimateEntry
	nil,                                 // 92: exarp.tools.ContextSummary.TokenEstimateEntry
	nil,                                 // 93: exarp.tools.Metrics.ComponentScoresEntry
	nil,                                 // 94: exarp.tools.Metrics.CountsEntry
	nil,                                 // 95: exarp.tools.ScorecardData.ComponentScoresEntry
	nil,                                 // 96: exarp.tools.ScorecardData.MetricsCountsEntry
	nil,                                 // 97: exarp.tools.HealthData.ScoresEntry
	(*timestamppb.Timestamp)(nil),       // 98: google.protobuf.Timestamp
}
var file_proto_tools_proto_depIdxs = []int32{
	89, // 0: exarp.tools.Memory.metadata:type_name -> exarp.tools.Memory.MetadataEntry
	...
	90, // 3: exarp.tools.MemoryResponse.categories:type_name -> exarp.tools.MemoryResponse.CategoriesEntry
	...
	91, // 6: exarp.tools.ContextResponse.token_estimate:type_name -> exarp.tools.ContextResponse.TokenEstimateEntry
	30, // 7: exarp.tools.ContextResponse.summaries:type_name -> exarp.tools.ContextSummary
	92, // 8: exarp.tools.ContextSummary.token_estimate:type_name -> exarp.tools.ContextSummary.TokenEstimateEntry
	...
	93, // 14: exarp.tools.Metrics.component_scores:type_name -> exarp.tools.Metrics.ComponentScoresEntry
	94, // 15: exarp.tools.Metrics.counts:type_name -> exarp.tools.Metrics.CountsEntry
	...
	95, // 24: exarp.tools.ScorecardData.component_scores:type_name -> exarp.tools.ScorecardData.ComponentScoresEntry
	96, // 25: exarp.tools.ScorecardData.metrics_counts:type_name -> exarp.tools.ScorecardData.MetricsCountsEntry
	97, // 26: exarp.tools.HealthData.scores:type_name -> exarp.tools.HealthData.ScoresEntry
	...
	98, // 57: exarp.tools.CachedTaskExecutionPack.generated_at:type_name -> google.protobuf.Timestamp
...
func file_proto_tools_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_proto_tools_proto_enumTypes,
